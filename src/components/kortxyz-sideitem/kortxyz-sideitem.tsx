...
export class KortxyzSideItem {
  @Element() sideitemEl: HTMLElement;
  ...
  componentDidLoad(){
    const contentDiv:any = this.sideitemEl.children[2];

    contentDiv.style.height = this.sideitemEl.parentElement.clientHeight + 'px'
  ...
  Resize = e => {
    if(e.clientX>150 && e.clientX<500){
      ...
      content.forEach(element => {
        element.style.width = (e.clientX - 40) + 'px';
      });
  ...
  icons = {
    ...
    save_alt: <svg class="sideitem__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
