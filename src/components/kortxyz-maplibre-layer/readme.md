...
| ---------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | -------------------------------------------- |
| `clicklink`      | `clicklink`       | (optional) When clicking a feature a new webpage is opened with the link prop. {} can be used to replace with a attribute. https://mypage.org/{ATTRIBUTENAME} | `boolean \| string`            | `undefined`                                  |
| `filter`         | `filter`          | Expression to fitler the layer                                                                                                                                | `any`                          | `undefined`                                  |
| `layerid`        | `layerid`         | Layer identification.                                                                                                                                         | `string`                       | `Math.random().toString(36).substring(2, 7)` |
| `layout`         | `layout`          | Layout properties for the layer.                                                                                                                              | `any`                          | `{}`                                         |
| `legendMetadata` | `legend-metadata` | Customize legend with a object like this {name:string,unit:string,labels:object (Map a value to a text that replaces it as a label) }                         | `any`                          | `{}`                                         |
...
| `proximity`      | `proximity`       | (optional) Distance to a GPS Fix that wil trigger the popup, disables clickbased popup                                                                        | `number`                       | `undefined`                                  |
